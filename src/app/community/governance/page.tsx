                  ...
                  <GlassCard className="p-4 active:scale-[0.98] mb-2">
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0">
                        ...
                        {r.voting_closes_at && <p className="text-[11px] text-aviva-gold mt-1">ปิดโหวต {fmt(r.voting_closes_at)}</p>}
                      </div>
                      <ArrowRight size={14} className="text-aviva-secondary/60 ml-2" />
                    </div>
                    {total > 0 && (
        ...
        <div>
          ...
          {loading ? (
            ...
            <GlassCard className="p-6 text-center">
              <p className="text-aviva-secondary text-xs">ไม่มีประชุมจะถึง</p>
            </GlassCard>
          ) : meetings.map(m => (
            <GlassCard key={m.id} className="p-4 mb-2">
              <div className="flex items-start gap-3">
                <CalendarDays size={16} className="text-aviva-gold mt-0.5" />
                <div>
        ...
        <div>
          ...
          {loading ? (
            ...
            <GlassCard className="p-6 text-center">
              ...
              <p className="text-aviva-secondary text-xs">ยังไม่มีเอกสารเผยแพร่</p>
            </GlassCard>
          ) : (
                  ...
                  <GlassCard className="p-3 active:scale-[0.98]">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[11px] text-aviva-secondary">{d.category} · {new Date(d.published_at).toLocaleDateString("th-TH")}</p>
                      </div>
                    </div>
                  </GlassCard>
                </a>
